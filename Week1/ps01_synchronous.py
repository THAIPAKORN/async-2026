...
def make_coffee(customer_name):
    ...
    sum(i * i for i in range(10000000))  # จำลองงานด้าน CPU-bound เล็กน้อย และรอ 5 วินาที
...
def main():
    ...
    print(f"{ctime()} | [Main PID: {main_pid}] [Main TID: {main_tid}] === เริ่มระบบจำลองลูกค้าแบบ Synchronous ===")
    start_time = time()
